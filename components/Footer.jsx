    ...
    >
        ...
        <div className="py-16 xl:py-[100px] flex flex-col xl:flex-row gap-[60px] xl:gap-[30px]">
          ...
          <div className="flex-1">
            <Link href="/" className="flex mb-6">
              <Image src="/assets/logobg.png" width={230} height={48} alt="" />
            </Link>
          ...
          <div className="flex-1 text-border">
            ...
            <ul className="flex flex-col gap-6">
              <li className="flex items-center gap-4">
                ...
                <p>265, Rashtrakuta, 3rd floor, Empire Industrial Centrum, plot no 22, Opp Karnataka Bank,
                  Chikhloli Ambernath-Badlapur Highway, Ambernath west - 421505
                </p>
              </li>
              <li className="flex items-center gap-4">
              ...
              <li className="flex items-center gap-4">
                ...
                <p>asmitadevelopers2009@gmail.com</p>
              </li>
            </ul>
          </div>
          {/* newsletter */}
      ...
      <div className="container mx-auto xl:px-0 py-12 border-t border-border/10 flex flex-col gap-6 xl:flex-row items-center justify-between">
        <p className="text-border">
          Copyright &copy; 2025 Asmita Developers. All rights reserved.
        </p>
        <Socials
